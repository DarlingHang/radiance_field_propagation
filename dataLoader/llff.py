...
class LLFFDataset(Dataset):
    ...
    def read_meta(self):
        ...
        for i in img_list:
            ...
            mask_path = image_path.replace('images_4', 'masks')
        ...
        if not self.is_stack:
            ...
            self.all_masks = torch.stack(self.all_masks, 0).reshape(-1,*self.img_wh[::-1]) 
        self.all_masks =  self.all_masks.to(torch.int64)
